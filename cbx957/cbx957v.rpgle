     **
     **  Program . . : CBX957V
     **  Description : Change NetServer user - VCP
     **  Author  . . : Carsten Flensburg
     **
     **
     **  Program description:
     **    Validity checking program for user profile existence.
     **
     **
     **  Compile options:
     **    CrtRpgMod Module( CBX957V )
     **              DbgView( *LIST )
     **
     **    CrtPgm    Pgm( CBX957V )
     **              Module( CBX957V )
     ...
     D  PxStatus                      1a
      ...
      /Free
        ...
        If  ERRC0100.BytAvl > *Zero  Or AutFlg = 'N';
          SndDiagMsg( 'CPD0006'
                    : '0000Special authority *SECADM and *IOSYSCFG required.'
                    );
